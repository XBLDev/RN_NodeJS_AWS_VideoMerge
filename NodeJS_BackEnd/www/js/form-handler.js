(function () {
  ...
  function init(){
    ...
    $('#videoConvertButton').click(videoConversionButtonHandler);

  }


  function videoConversionButtonHandler (evt) {
    //  var testForm = document.getElementById('testForm');
      ...
      $.ajax({
        ...
        // },
        success: VCpostSuccessHandler
      });
  }

  function VCpostSuccessHandler (jsonData) {
